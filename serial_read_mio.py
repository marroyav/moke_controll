...
time.sleep(waitlittle)
ser.write(chr(122)); ser.write(chr(1)); ser.write(chr(0)); #number of samples 10
time.sleep(waitlittle)
...
#for i in range(4): print byte_array[10*i:10*i+10] # print out the 4 channels
        print byte_array # print out the 4 channels
#print byte_array[10:10+10] # print out the 4 channels
